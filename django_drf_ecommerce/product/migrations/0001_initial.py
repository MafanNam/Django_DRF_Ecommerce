# Generated by Django 4.2.3 on 2023-07-29 22:24

from django.db import migrations, models
import django.db.models.deletion
import django_drf_ecommerce.product.fields
import mptt.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False)),
                ('order', django_drf_ecommerce.product.fields.OrderField(blank=True)),
                ('weight', models.FloatField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_line', to='product.product')),
                ('product_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_line_type', to='product.producttype')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
